...
public class ArchiveAdapter extends RecyclerView.Adapter<ArchiveAdapter.ArchiveViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ArchiveViewHolder holder, int i) {
        ...
        holder.tv_sender_phone.setText(travelList.get(i).getSender_phone());
        ...
        holder.tv_receiver_phone.setText(travelList.get(i).getSender_phone());
    ...
    public class ArchiveViewHolder extends RecyclerView.ViewHolder {
        private TextView tv_date,tv_start_location,tv_sender,tv_sender_phone,tv_receiver_loc,tv_receiver,tv_receiver_phone;
        public ArchiveViewHolder(@NonNull View itemView) {
            ...
            tv_sender_phone = itemView.findViewById(R.id.tv_sender_phone);
